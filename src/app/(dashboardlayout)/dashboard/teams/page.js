                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                      ...
                      <input type="text" name="teamname" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Project title" required />
                    </div>
                    <div>
                      <label className="block mb-2 text-sm font-medium text-gray-900 ">team department</label>
                      <input type="date" name="teamdepartment" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Project title" required />
                    </div>
                    <div>
